...
class House
{
    ...
    /**
     * @Vich\UploadableField(mapping="houses", fileNameProperty="firstPicture")
     * @var File|null
     */
     ...
     */
    public function setFirstPictureFile(?File $firstPictureFile)
    {
    ...
    public function setConnexion(?string $connexion): self
    {
